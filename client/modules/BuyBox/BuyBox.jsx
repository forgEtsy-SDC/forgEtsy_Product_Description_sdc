            ...
            <div className={Style.people_want_this_wrapper}>
                ...
                <div className={Style.people_want_this_left}>
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48' height='48' width='48' aria-hidden='true' focusable='false' className={Style.svg}>
                        ...
                        <line fill='none' stroke='#333333' strokeWidth='2' stroke-strokeLinecap='round' strokeLinejoin='round' x1='37' y1='8' x2='33.8' y2='11.1' className={Style.line_one}></line>
                        <line fill='none' stroke='#333333' strokeWidth='2' stroke-strokeLinecap='round' strokeLinejoin='round' x1='29' y1='6' x2='29' y2='10' className={Style.line_two}></line>
